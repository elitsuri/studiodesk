...
app = FastAPI(
    title="StudioDesk",
    description="A desktop productivity suite with document editing, file sync, and task management",
    version="1.0.0",
)
...
@app.get("/health")
def health_check():
    return {"status": "healthy", "service": "StudioDesk"}
